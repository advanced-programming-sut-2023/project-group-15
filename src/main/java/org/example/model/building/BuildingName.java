...
public enum BuildingName {
    ...
    STABLE(400 , GOLD_COIN ,20, WOOD, 0, HORSE, null, 2, "productive", 10),
    ...
    OIL_SMELTLER(100 , GOLD_COIN ,10, IRON, 1, OIL_POT, null, 2, "productive", 15),
    OX_TETHER(5, WOOD, 0, null, 1, "productive", 10),
    ARMOURY(5, WOOD, 100, "store", 20),
    SOURCESTORE(0, WOOD, 500, "store", 15),
    ...
    INN(5, 100 , GOLD_COIN , 20, WOOD,  "city", 10),
    ...
    //city buildings
    BuildingName(int rate, int numberOfMaterial1, Products material1Name, int numberOfMaterial2, Products material2Name, String type, int hp) {
